...
void moverMotorOjosIzquierda() {
    ...
    myservo.write(100);// move servos to center position -> 0°
...
void moverMotorOjosDerecha() {
    ...
    myservo.write(60);// move servos to center position -> 0°
...

{
  ...
  digitalWrite(GND_PIN, LOW); // Establece el pin en LOW para conectar GND al motor
